...
namespace _35_1_Korotun_NeurMih.NeiroMix
{
    class Network
    {
        ...
        private HiddenLayer hidden_layer1 = new HiddenLayer(76, 15, NeuronType.Hidden, nameof(hidden_layer1));
        private HiddenLayer hidden_layer2 = new HiddenLayer(30, 76, NeuronType.Hidden, nameof(hidden_layer2));
